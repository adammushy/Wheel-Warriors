...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        {
            if (other.gameObject.CompareTag("AIBlack"))
            {
                StartCoroutine(StopDriving());
            }
            if (other.gameObject.CompareTag("AIBlue"))
            {
                StartCoroutine(StopDriving());
            }
            if (other.gameObject.CompareTag("AIRed"))
            {
                StartCoroutine(StopDriving());
            }
            if (other.gameObject.CompareTag("AIYellow"))
            {
                StartCoroutine(StopDriving());
            }
        }
